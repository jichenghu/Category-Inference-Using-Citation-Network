...
'''
optimizer = optim.Adam(net.parameters(), lr = 7e-4, weight_decay = 1e-5)
...
'''
Here's the prediction.You can change the file name from 25_0 to 25_1,25_2,10_0……
to see the result in different test sets.
The file sample numbers are shown below:
    1939 in 10%
    4849 in 25%
    7758 in 40%
'''
file_sample_num=4849
test_label_file = 'dest_test_25_0.csv'
test_y = np.loadtxt(open(test_label_file, "r"), delimiter=",", skiprows=0)
test_x_file = 'data_test_25_0.csv'
...
test_pre_label=[]
for i in range(file_sample_num):
    x = -1
    pos = 0
    for j in range(10):
