...
int main()
{
	string filePath = "C:/Users/cuixiuping/Desktop/Cora";
	string test = "test.txt";
	string bayes_result = "res/BAYES_25_0.csv";
	string marcov_result = "res/CRF_PRLP_25_0.csv";
	string PT = "PT.txt";
	string PP = "PP.txt";
	string PA = "PA.txt";
